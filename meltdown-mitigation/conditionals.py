...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    return bool(temperature < float(800) and neutrons_emitted > float(500) and temperature * neutrons_emitted < 500000)
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage = (float(generated_power) / float(theoretical_max_power)) * 100
